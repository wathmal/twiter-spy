  ...
  static getRangeSearchQuery(){
    ...
    * */
    ...
    if(fromDate !== null && toDate === null){
      ...
      esquery["body"]["query"]["filtered"]["filter"] = {"range": {"created_at": {"gt": moment(fromDate).format("YYYY-MM-DD"), "lt": nextDay.format("YYYY-MM-DD")}}}
    }
    else if(fromDate !== null && toDate !== null){
      esquery["body"]["query"]["filtered"]["filter"] = {"range": {"created_at": {"gt": moment(fromDate).format("YYYY-MM-DD"), "lt": moment(toDate).format("YYYY-MM-DD")}}}
